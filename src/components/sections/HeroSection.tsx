...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="animate-float absolute left-[6%] top-[22%] hidden h-28 w-40 rounded-2xl border border-amber-400/30 bg-amber-400/5 backdrop-blur-md md:block" />
        <div
          className="animate-float absolute right-[8%] top-[30%] hidden h-36 w-28 rounded-2xl border border-orange-500/25 bg-orange-500/5 backdrop-blur-md md:block"
          style={{ animationDelay: "1.2s" }}
        />
        <div
          className="animate-float absolute bottom-[18%] left-[18%] hidden h-20 w-52 rounded-xl border border-yellow-400/20 bg-yellow-400/5 backdrop-blur-md lg:block"
          style={{ animationDelay: "2s" }}
        />
        <div className="absolute right-[12%] top-[18%] font-mono text-[10px] tracking-widest text-amber-300/50 animate-pulse-glow">
          NEURAL BRAIN · LINKED
        </div>
        <div
          className="absolute left-[10%] bottom-[22%] font-mono text-[10px] tracking-widest text-amber-300/40 animate-pulse-glow"
